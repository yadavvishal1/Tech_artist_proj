...
- **Decision 6**: **Procedural Car Tilt & Swerve Drifting**: To maximize "juiciness", I first implemented a programmatic Z-axis tilt to emphasize cornering forces. After testing the feel, I layered on a weighted Y-axis rotational drift during lane switches in `CarController.cs`. This combination creates a highly responsive, satisfying arcade driving feel without relying on expensive physics simulations.
